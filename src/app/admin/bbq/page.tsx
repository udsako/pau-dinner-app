                ...
                {Object.entries(starchStats).map(([name, count]) => (
                  ...
                  >
                    ...
                    <div>
                      ...
                      <p className="text-2xl font-light" style={{ fontFamily: "var(--font-cormorant)", color: "var(--cream)" }}>
                        {count}
                      </p>
                    </div>
                  </div>
                ...
                <thead>
                  <tr style={{ borderBottom: "1px solid rgba(201,168,76,0.15)" }}>
                    {["#", "Name", "Department", "Protein", "Starch", "Time"].map((h) => (
                      <th
                        key={h}
                        className="text-left py-3 px-3 text-xs uppercase tracking-widest font-medium"
                        style={{ color: "var(--text-muted)" }}
                      >
                        {h}
                      </th>
                ...
                <tbody>
                  {ordersLoading ? (
                    ...
                    filteredOrders.map((order, idx) => (
                      ...
                      >
                        <td className="py-3 px-3" style={{ color: "var(--text-muted)", fontSize: "12px" }}>
                          {idx + 1}
                        </td>
                        <td className="py-3 px-3 font-medium" style={{ color: "var(--cream)" }}>
                          {order.studentName}
                        </td>
          ...
          <div>
            {menuMsg && (
              <div
                ...
                style={{
                  background: menuMsg.type === "success" ? "rgba(52,211,153,0.08)" : "rgba(239,68,68,0.08)",
                  border: `1px solid ${menuMsg.type === "success" ? "rgba(52,211,153,0.25)" : "rgba(239,68,68,0.25)"}`,
                  borderRadius: "2px",
                  color: menuMsg.type === "success" ? "#34d399" : "#fca5a5",
                }}
              >
                {menuMsg.text}
            ...
            >
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                <div>
                  <label className="block text-xs mb-1.5 uppercase tracking-widest" style={{ color: "var(--text-muted)" }}>
                    Item Name *
                  </label>
                  <input
                    type="text"
                    ...
                    placeholder="e.g. Turkey, Fried Yam, Coleslaw"
                ...
                <div>
                  ...
                  >
                    {Object.entries(CATEGORY_LABELS).map(([val, label]) => (
                      <option key={val} value={val} style={{ background: "#1a1510" }}>
                        {label}
                      </option>
                    ))}
                  </select>
              ...
              <div
                ...
                style={{ background: "rgba(201,168,76,0.05)", border: "1px solid rgba(201,168,76,0.12)", borderRadius: "2px" }}
              >
              ...
              <button
                ...
                className="px-6 py-2.5 text-sm font-medium uppercase tracking-widest transition-all"
                style={{
                  background: "linear-gradient(135deg, var(--gold-dark), var(--gold))",
                  color: "var(--charcoal)",
                  borderRadius: "2px",
            ...
            {menuLoading ? (
              ...
              <p className="text-center py-10 text-sm" style={{ color: "var(--text-muted)" }}>
                No BBQ menu items yet. Add one above.
              </p>
            ) : (
                              ...
                              <div className="grid gap-3">
                                ...
                                <div className="flex gap-2">
                                  <button
                                    ...
                                    style={{ background: "var(--gold)", color: "var(--charcoal)", borderRadius: "2px" }}
                                  >
                                    Save
                                  </button>
                                  <button
                                    ...
                                    className="px-4 py-1.5 text-xs uppercase tracking-widest"
                                    style={{ border: "1px solid rgba(201,168,76,0.3)", borderRadius: "2px", color: "var(--text-muted)" }}
                                  >
                                    Cancel
                                  </button>
                                </div>
                              ...
                              <div className="flex items-start justify-between gap-4">
                                <div>
                                  <div className="flex items-center gap-2 mb-0.5">
                                    <span className="font-medium text-sm" style={{ color: "var(--cream)" }}>
                                      {item.name}
                                    </span>
                                    {!item.isAvailable && (
                                      <span className="text-xs px-1.5 py-0.5" style={{ background: "rgba(239,68,68,0.12)", border: "1px solid rgba(239,68,68,0.2)", borderRadius: "2px", color: "#fca5a5" }}>
                                        Disabled
                                      </span>
                                    )}
                                  </div>
                                  {item.description && (
                                    <p className="text-xs mb-1" style={{ color: "var(--text-muted)" }}>{item.description}</p>
                                  )}
                                ...
                                <div className="flex gap-2 flex-shrink-0">
                                  <button
                                    ...
                                    style={{ border: "1px solid rgba(201,168,76,0.25)", borderRadius: "2px", color: "var(--gold)" }}
                                  >
                                    Edit
                                  </button>
                                  <button
                                    ...
                                    className="px-3 py-1 text-xs"
                                    style={{ border: "1px solid rgba(239,68,68,0.25)", borderRadius: "2px", color: "#fca5a5" }}
                                  >
                                    Delete
                                  </button>
                                </div>
